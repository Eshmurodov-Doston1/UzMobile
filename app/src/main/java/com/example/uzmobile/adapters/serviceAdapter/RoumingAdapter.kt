...
class RoumingAdapter(var onItemClickListener: RoumingAdapter.OnItemClickListener):ListAdapter<SMSMoney,RoumingAdapter.Vh>(MyDiffUtill()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RoumingAdapter.Vh {
